...
namespace FlashDevelop.Managers
{
    class TabbingManager
    {
        ...
        /// <summary>
        /// Activates next document in tabs. Optionaly only between documents in the same window as the current one
        /// </summary>
        ...
        /// <summary>
        /// Visual Studio style keyboard tab navigation: similar to Alt-Tab. Optionaly only between documents in the same window as the current one
        /// </summary>
        public static void NavigateTabHistory(Int32 direction, Boolean fromDocumentGroup)
        {
            Int32 currentIndex = 0;
            List<ITabbedDocument> tabHistory;
